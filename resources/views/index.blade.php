...
<title>Indonesia Sport Tourism</title>
...
<div class="container-fluid">
    <nav class="navbar navbar-default">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Indonesia Sport Tourism</a>
        </div>

        <div class="collapse navbar-collapse js-navbar-collapse">
          <ul style="margin-right:10px;" class="nav navbar-nav">
              <li class="dropdown">
              <li><a href="#">About Us</a></li>
              <li><a href="#">Contact Us</a></li>
          </ul>
            <ul class="nav navbar-nav">
                <li style="margin-right:10px;" class="dropdown mega-dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Current Events <span class="caret"></span></a>
                    <ul class="dropdown-menu mega-dropdown-menu">
                        <li class="col-sm-3">
                            <ul>
                                <li class="dropdown-header">Slider 1</li>
                ...
                <li class="dropdown mega-dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Event By Categories <span class="caret"></span></a>
                    <ul class="dropdown-menu mega-dropdown-menu">
                        <li class="col-sm-3">
                            <ul>
                                <li class="dropdown-header">Features</li>
                        ...
                        <li class="col-sm-3">
                            <ul>
                                <li class="dropdown-header">Slider 2</li>
...
<div class="container-fluid">
  <div class="col-sm-3">
    <center>
    <img src="http://via.placeholder.com/300x560" alt="">
    <center/>
  </div>
  <div class="col-sm-9">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <img src="http://via.placeholder.com/1200x700" alt="Chicago">
    </div>

    <div class="item">
      <img src="http://via.placeholder.com/1200x700" alt="New York">
    </div>
  </div>
...
<div class="agileits-w3layouts-copyright">
  <div class="container">
    <p>© 2018 Indonesia Sport Tourism. All rights reserved | Design by <a href="http://w3layouts.com">Zadda</a></p>
  </div>
</div>
<!-- //copyright -->
